...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/resources`, lastModified: new Date("2026-04-28"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/resources/brandscript`, lastModified: new Date("2026-04-28"), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/resources/ai-prompts`, lastModified: new Date("2026-04-28"), changeFrequency: "monthly", priority: 0.7 },

...
const archetypes: Record<string, Archetype> = {
  ...
  warrior: {
    ...
    recommendation:
      "A clean, professional site with your Google Business Profile set up properly. You don't need to dominate the internet. You just need to not lose the people already looking for you.",
    tier: "Get Found",
  },
  dabbler: {

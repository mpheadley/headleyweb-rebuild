...
export default function Home() {
  return (
    <main id="main-content">
      ...
      <section className="pt-28 pb-12 md:pt-36 md:pb-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
      ...
      {/* ═══ Google Reviews ═══ */}
      <section className="pt-0 pb-16 px-6 bg-hw-light border-b border-black/5">
        <div className="max-w-4xl mx-auto grid sm:grid-cols-2 gap-6">
          {[
            { quote: "He is GENUINELY invested in this community!! 10/10 highly recommend.", name: "Jean E.", location: "Jacksonville" },
            { quote: "Fast, easy to work with, and a great help.", name: "Micah J.", location: "rental business owner" },
          ].map((r) => (
            <div key={r.name} className="bg-white rounded-xl p-6 shadow-sm border border-black/5 animate-on-scroll">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-hw-primary text-sm tracking-wide">★★★★★</span>
              </div>
              <p className="text-hw-text text-sm leading-relaxed mb-3">&ldquo;{r.quote}&rdquo;</p>
              <p className="text-hw-text-light text-xs">— {r.name}, {r.location}</p>
            </div>
          ))}
        </div>
      </section>
